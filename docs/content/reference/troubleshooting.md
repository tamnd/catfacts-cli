...
Most of these come down to network reality or how catfacts serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

catfacts rate-limits like any public site. catfacts already paces
...
Where a surface is gated, catfacts reads a cookie or token you supply
...
`catfacts`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what catfacts actually did
